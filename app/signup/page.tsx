    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-display font-bold tracking-tighter text-slate-100 mb-2">Create Account</h1>
          <p className="text-slate-400 font-medium">Join our community of comic lovers</p>
        </div>
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-[2.5rem] p-8 md:p-10 backdrop-blur-xl shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-4">Username</label>
              <div className="relative group">
                <User className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-sky-500 transition-colors" />
                <input
                  type="text"
                  required
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 ml-4">Password</label>
              <div className="relative group">
        ...
        <p className="text-center mt-10 text-slate-400 font-medium">
          ...
          <Link href="/login" className="text-sky-500 font-bold uppercase tracking-widest hover:text-sky-400 transition-colors ml-2">
            Sign In
          </Link>
        </p>
      </div>
